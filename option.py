...
# Data specifications
parser.add_argument('--dir_data', type=str, default='./DataFiles',
...
parser.add_argument('--model', default='SFFN',
                    help='model name')
...
# Loss specifications
parser.add_argument('--loss', type=str, default='1*L1+0.1*Amp+0.1*Pha',
...
parser.add_argument('--save_models', action='store_true',
                    help='whether to save part of the intermediate models?')
parser.add_argument('--save_models_freq', type=int, default=20,
                    help='the frequency of save models')
